...
public class TutorialManager : MonoBehaviour {
    ...
    private List<string> _messages = new() {
        "Welcome, mayor. At last, you’ve arrived. Our settlement is fragile, and the dead will find us soon.",
        ...
        "But our supplies won’t last. We need wood. Build a Wood Workshop near the trees, then assign five workers to gather timber.",
        ...
        "The dead draw closer. Build Wooden Supports from the Defense I tab, and mount Sentries upon them. Place at least four, guarding every direction.",
        "At last, shield the town with wooden walls. Hurry, the dead are at our gates."
    };
